            ...
            <div class="h-100 bg-light p-30">
                ...
                <div class="d-flex mb-3">
                   {{--
                    ...
                    --}}
                    <small class="pt-1 fs-5"><i class="fa-solid fa-eye"></i>{{ $data->view_count }}</small>
                </div>
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    ...
                    <button class="btn btn-primary px-3" id="button"><i class="fa fa-shopping-cart mr-1"></i> Add To
                        Cart</button>
                </div>
...
<script>
    ...
    $('#button').click(function(){
        ...
        $.ajax({
            Type: 'get',
            url: 'http://127.0.0.1:8000/ajax/createCart',
            data: $source,
            dataType: 'json',
            success:function(response){
                if(response.status=='success'){
                    window.location.href="http://127.0.0.1:8000/user/userList";
                }
            }
        })
