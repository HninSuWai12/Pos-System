...
<div class="container-fluid">
    <div class="row">
        <div class="col-3 offset-1">
            <a href="{{ route('user#info') }}"><button class="btn bg-dark text-white my-3">Back</button></a>
        </div>
    </div>
                ...
                <form action="{{ route('user#update') }}" method="post" enctype="multipart/form-data">
                   ...
                   <div class="row">
                    <div class="col-3">
                        ...
                        @else
                            <img src="{{ asset('storage/'.Auth::user()->image) }}" class="img-thumbnail col-10"alt="">
                        @endif
                    ...
                    <div class="col-7">
                        ...
                        <div class="form-group">
                            ...
                            <input id="cc-pament" name="role" type="text" class="form-control @error('address') is-invalid @enderror" value="{{  (Auth::user()->role) }}" aria-required="true" aria-invalid="false" placeholder="..." disabled>
